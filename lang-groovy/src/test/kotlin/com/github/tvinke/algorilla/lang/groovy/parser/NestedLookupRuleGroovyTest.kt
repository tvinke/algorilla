...
internal class NestedLookupRuleGroovyTest {
    ...
    inner class PositiveCases {
        @Test
        fun `should detect list contains inside each loop`() {
            val findings = analyzeFixture("nested-lookup/positive/list-contains-in-each.groovy")
    ...
    inner class NegativeCases {
        @Test
        fun `should not flag set contains in each loop`() {
            val findings = analyzeFixture("nested-lookup/negative/set-contains-in-each.groovy")
