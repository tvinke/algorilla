...
internal class HeavyweightObjectPerInvocationRuleGroovyTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect ObjectMapper created inside method body`() {
            val findings = analyzeFixture("expensive-construction/positive/mapper-in-method.groovy")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag non-heavyweight object creation`() {
            val findings = analyzeFixture("expensive-construction/negative/no-heavyweight-types.groovy")
