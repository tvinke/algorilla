...
internal class RepeatedCollectionIterationRuleGroovyTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect two each loops over the same collection`() {
            val findings = analyzeFixture("repeated-collection-iteration/positive/two-each-loops.groovy")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag each loops on different collections`() {
            val findings = analyzeFixture("repeated-collection-iteration/negative/different-sources.groovy")
