...
## [0.4.0](https://github.com/tvinke/algorilla/compare/v0.3.1...v0.4.0) (2026-09-15)


### Features

* add heavyweight-types to spring/guava/ktor overlays ([#156](https://github.com/tvinke/algorilla/issues/156)) ([794f277](https://github.com/tvinke/algorilla/commit/794f2772aa27151a0cbd86ae91c716c7b807bd16))
* anchor-based Issue Groups view (--view groups) ([#158](https://github.com/tvinke/algorilla/issues/158)) ([8a61f01](https://github.com/tvinke/algorilla/commit/8a61f014af887b9ebc9696f7aff2f65f7d8cbefe))
...
* repeated-linear-scan now catches repeated sort() too ([#153](https://github.com/tvinke/algorilla/issues/153)) ([e8394fc](https://github.com/tvinke/algorilla/commit/e8394fc4c0fddc79ff7ca1f87a0dd8e81ac0785c))
* sealed resolution confidence + Konsist/ArchUnit guards for the shared cross-method utils ([#120](https://github.com/tvinke/algorilla/issues/120)) ([8b699b6](https://github.com/tvinke/algorilla/commit/8b699b6130c004fca921f51b1f8589b435309915))
* shared receiver-aware self-call check (cc [#64](https://github.com/tvinke/algorilla/issues/64)/[#71](https://github.com/tvinke/algorilla/issues/71) groundwork) ([bcefc05](https://github.com/tvinke/algorilla/commit/bcefc05591b0ac708493ee64f5b1431c7d74d63c))


### Bug Fixes

* --list-rules loads custom rules from the given project, not cwd ([#154](https://github.com/tvinke/algorilla/issues/154)) ([12bd2ab](https://github.com/tvinke/algorilla/commit/12bd2ab7bf99b4cb24529bff0acc1a73990c7437))
* 8 word-boundary rules now cross-check the declared type ([#139](https://github.com/tvinke/algorilla/issues/139)) ([168cecb](https://github.com/tvinke/algorilla/commit/168cecb0092cdcfdfa6ff85f4885b1ecbd565212))
...
* AnalysisCache didn't invalidate on version or rule-config changes ([#151](https://github.com/tvinke/algorilla/issues/151)) ([2238f9c](https://github.com/tvinke/algorilla/commit/2238f9c23058dc6c6f5b590bde1b8059fe06bbc3))
* buildChain treated a repeated producer-arg reference as a fan-in ([f18a601](https://github.com/tvinke/algorilla/commit/f18a601985e89096bc0e4b856e42ffb468a3a0d6))
* CardinalityExplosionRule resolves variable initializers instead of matching names ([#149](https://github.com/tvinke/algorilla/issues/149)) ([b3ccbf4](https://github.com/tvinke/algorilla/commit/b3ccbf45a9c2bf38e7cd68ce9351fdc891938cb6))
* chained-getters counted a merge of two lookups as one more chain link ([96c715b](https://github.com/tvinke/algorilla/commit/96c715bb6e4369629c4bad8bd0bdb3c3fd3bc57d))
* ChainedGettersRule's isGetterPattern missing the same word boundary ([9e8b410](https://github.com/tvinke/algorilla/commit/9e8b41053dc2e6f36cf8f26027b7faddb096be68))
* confidence was only checked at the outermost hop, not the chain ([#130](https://github.com/tvinke/algorilla/issues/130)) ([820c607](https://github.com/tvinke/algorilla/commit/820c60747480eb59666e72232a7a774c67c8d47d))
* containsTypeReference only checked the leading side of the match ([fc14d83](https://github.com/tvinke/algorilla/commit/fc14d8313a49b173c176669192a68816905a3f23))
...
* findCallByName re-found the wrong call when a callee body repeats a method name ([1904054](https://github.com/tvinke/algorilla/commit/1904054a4e4fa3771b2ed8dc4f01f08d6a34e70c))
...
* heavyweight-types config merge + per-language seeding for Kotlin/Groovy ([#152](https://github.com/tvinke/algorilla/issues/152)) ([9f24560](https://github.com/tvinke/algorilla/commit/9f245601b48e891e759f9b175398acf99df91543))
* IO-target suffix matching had no word boundary either ([caac787](https://github.com/tvinke/algorilla/commit/caac7871010e5ab69bcb3163c17dd12484cb0500))
* IOInLoopRule was the third rule silently ignoring chain confidence ([#136](https://github.com/tvinke/algorilla/issues/136)) ([40b3d12](https://github.com/tvinke/algorilla/commit/40b3d12a7f08ba0798eb0c799b83669229350ce2))
* isBulkLoadCall missing the same word boundary as the other bulk-load-prefix checks ([d292755](https://github.com/tvinke/algorilla/commit/d29275579c0fda5d467885cb2358af52321e84b4))
* isCollection/isList trusted NAME_HEURISTIC types same as declared ones ([4e4fe3e](https://github.com/tvinke/algorilla/commit/4e4fe3e22cae879444d79d42e00981a6e694736d))
* isCollectionLookup consulted the name heuristic before the resolved type at all ([5d1dd0e](https://github.com/tvinke/algorilla/commit/5d1dd0e961b2496b755f5f2fbc9bbb17f31fed7d))
* isCompileCall read a receiver name as proof of type, not just its shape ([83ce6d0](https://github.com/tvinke/algorilla/commit/83ce6d0ba7a7a8fc6abac6fad4231364b4c68a33))
...
* isMapTarget/isNonRegexMatchesTarget ignored a known type once it didn't match ([2b8b046](https://github.com/tvinke/algorilla/commit/2b8b04622963912c1cac7df4f1f9ea7abcf3e0c1))
* isPartitionedIteration's de-pluralized prefix match had no word boundary ([5549ae5](https://github.com/tvinke/algorilla/commit/5549ae5cd714533f0d8565dbccdae59bb196b006))
* isRemovalCall's suffix exclusion missing the same word boundary ([1543617](https://github.com/tvinke/algorilla/commit/154361771423e5680f2d4fcca64fef17d2c54438))
* isSequentialReadPrefix missing the camelCase boundary its siblings already have ([110ea52](https://github.com/tvinke/algorilla/commit/110ea520f867ef296339a0c4b0d2d74b289fd3b4))
* isStringOrCopyMethod's skip-prefix check missing the same word boundary ([1505ea9](https://github.com/tvinke/algorilla/commit/1505ea986d18616d178e924e2942dbb54c5eb362))
...
* Java precision improvements (cycles 5-6) ([0bb119b](https://github.com/tvinke/algorilla/commit/0bb119b57961f6ee171b49c6a3092df40a263ff1))
* N+1 batch-method suffix/prefix checks had the same missing word boundary ([48f4113](https://github.com/tvinke/algorilla/commit/48f4113b4bfe8b9ba7227cb9252a409890fb2ae0))
...
* parseListItem dropped inline YAML comments onto the value, and isMonadicTarget matched substrings ([f395a22](https://github.com/tvinke/algorilla/commit/f395a221aa64ce36d85ed3ebd2dd8e2c4aef4ab5))
...
* recursion detection was matching call names only, not receivers ([a53f10f](https://github.com/tvinke/algorilla/commit/a53f10f4539aaea23bdb840da1107c99137155c8))
* recursion detection was matching call names only, not receivers ([764f8fb](https://github.com/tvinke/algorilla/commit/764f8fb7a33a5c0ef916e87ddb417513be1c5332))
* repository-fetch and getter prefix checks had no word boundary either ([0877231](https://github.com/tvinke/algorilla/commit/0877231232e460e38986357487769158a24d3b85))
* repository-patterns contains-check had no boundary on either side ([7370fdd](https://github.com/tvinke/algorilla/commit/7370fddde1d9d1019b18e98bde5b38d2a6c399b4))
...
* same isCompileCall receiver-text-as-type-proof bug as RepeatedRegexInLoopRule ([38ff345](https://github.com/tvinke/algorilla/commit/38ff3450960c39c3aa06fc9163c65ee3b2f9634e))
...
* thread resolution confidence and source language through the last stragglers ([#144](https://github.com/tvinke/algorilla/issues/144)) ([1334155](https://github.com/tvinke/algorilla/commit/133415505979a97bc1312a2af557c48d2ccda876))
* UncachedGetterRule's isGetterPattern, same missing boundary as ChainedGettersRule ([67bcdbc](https://github.com/tvinke/algorilla/commit/67bcdbca921d4fb5ad2c7228cea09d4ad328f9eb))
* visited-set detection hardcoded Set.contains(), missing JS/TS's has() ([c08532a](https://github.com/tvinke/algorilla/commit/c08532ad8071379be9033a9695cc772bc96706ba))
* word-boundary bugs across the rest of the bare-contains() sweep ([#119](https://github.com/tvinke/algorilla/issues/119)) ([488b34f](https://github.com/tvinke/algorilla/commit/488b34f7a23dbc7bb539716bdfb8f56cb287927f))
