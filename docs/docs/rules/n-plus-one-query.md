...
!!! info "Rule details"
    ...
    | **[Confidence](/algorilla/guide/understanding-output/#confidence-levels)** | HIGH (repository/dao target) · MEDIUM (other targets) · LOW (ambiguous cross-method resolution) |
