...
| [Expensive Sort Comparator](rules/expensive-sort-comparator.md) | Linear search in comparator | O(n² log n) → O(n log n) |
| [Date in Sort](rules/date-in-sort.md) | Date parsing in comparator | O(n log n) → O(n log n)* |
