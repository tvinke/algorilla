...
internal class RegexRecompilationInLoopRuleNameVsTypeTest {
    ...
    // the same missing boundary, found during the cc#105 bare-.contains() sweep - the target
    // was lowercased first, then bare-contains against "predicate"/"matcher". "predicated"
    // (past participle, unrelated to a Predicate-typed variable) satisfied it too.
    @Test
