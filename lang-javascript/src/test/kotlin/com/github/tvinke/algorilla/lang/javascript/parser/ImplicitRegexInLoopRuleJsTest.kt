...
internal class ImplicitRegexInLoopRuleJsTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect regex literal arguments in loop`() {
            val findings = analyzeFixture("implicit-regex-in-loop/positive/regex-in-loop.js")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag split and replace with string literal arguments`() {
            val findings = analyzeFixture("implicit-regex-in-loop/negative/string-args-in-loop.js")
