...
internal class InLoopCollectionBuildingRuleJsTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect concat inside loop`() {
            val findings = analyzeFixture("in-loop-collection-building/positive/concat-in-loop.js")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag toLowerCase in loop`() {
            val findings = analyzeFixture("in-loop-collection-building/negative/to-lower-case-in-loop.js")
