...
internal class LoopInvariantHoistingRuleKotlinTest {
    ...
    inner class PositiveCases {
        @Test
        fun `should detect loop-invariant config call inside for loop`() {
            val findings = analyzeFixture("loop-invariant-hoisting/positive/config-in-loop.kt")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag call that depends on loop variable`() {
            val findings = analyzeFixture("loop-invariant-hoisting/negative/depends-on-item.kt")
