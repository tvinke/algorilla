...
internal class RedundantExpensiveCallRuleKotlinTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect replaceAll called twice with same arguments`() {
            val findings = analyzeFixture("redundant-expensive-call/positive/same-args.kt")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag replaceAll with different arguments`() {
            val findings = analyzeFixture("redundant-expensive-call/negative/different-args.kt")
