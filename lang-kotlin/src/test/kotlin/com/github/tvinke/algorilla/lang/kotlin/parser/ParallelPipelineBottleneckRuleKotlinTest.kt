...
internal class ParallelPipelineBottleneckRuleKotlinTest {
    ...
    inner class PositiveCases {
        ...
        fun `should detect parallelStream forEach with shared mutation`() {
            val findings = analyzeFixture("parallel-pipeline-bottleneck/positive/shared-mutation.kt")
    ...
    inner class NegativeCases {
        @Test
        fun `should not flag sequential stream with forEach`() {
            val findings = analyzeFixture("parallel-pipeline-bottleneck/negative/sequential-stream.kt")
