...
internal class HiddenNestedLoopRuleKotlinTest {
    ...
    inner class PositiveCases {
        @Test
        fun `should detect loop inside method called from outer loop`() {
            val findings = analyzeFixture("hidden-nested-loop/positive/loop-calls-method-with-loop.kt")
    ...
    inner class NegativeCases {
        ...
        fun `should not flag method without inner loop`() {
            val findings = analyzeFixture("hidden-nested-loop/negative/loop-calls-method-without-loop.kt")
