...
internal class UnmemoizedRecursionRuleKotlinTest {
    ...
    inner class PositiveCases {
        @Test
        fun `should detect unmemoized fibonacci recursion`() {
            val findings = analyzeFixture("unmemoized-recursion/positive/fibonacci.kt")
    ...
    inner class NegativeCases {
        @Test
        fun `should not flag tree traversal recursion`() {
            val findings = analyzeFixture("unmemoized-recursion/negative/tree-traversal.kt")
