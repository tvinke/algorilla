...
internal class CardinalityExplosionRuleKotlinTest {
    ...
    inner class PositiveCases {
        @Test
        fun `should detect cartesian product from nested loops over different lists`() {
            val findings = analyzeFixture("cardinality-explosion/positive/cartesian-product.kt")
    ...
    inner class NegativeCases {
        @Test
        fun `should not flag single loop building a list`() {
            val findings = analyzeFixture("cardinality-explosion/negative/single-loop.kt")
